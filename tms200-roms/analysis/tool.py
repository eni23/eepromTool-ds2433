...
parser.add_argument("-c", "--clear", help="Clear the flash write all zeros.", action="store_true")
...
def writeOldestToChip(flashPath=False):
...
if args.load:
    ...
    writeOldestToChip(flashPath=args.filename)
